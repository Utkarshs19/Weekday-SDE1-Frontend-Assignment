        ...
        <div className="job-main">
          ...
          <div className="job-description">
            ...
            <div className="roleResponsibility">
              ...
              <Typography>
                1. ML Algorithm Development: Design advanced ML algorithms integrating 
                traditional techniques and modern NLP stacks, such as Large Language 
                Models (LLMs), for robust natural language processing tasks.
              </Typography>
              <Typography>
              ...
              <Typography>
                3. Data Engineering & Software Development: Architect robust data 
                pipelines integrating data ingestion, preprocessing, and transformation 
                stages to support ML model training efficiently and reliably.
              </Typography>
              <Typography>
